...
class TurtlebotController:
    def __init__(self, name):
        ...
        self.goal_sub = rospy.Subscriber("/goals", PoseStamped, self.goal_callback, queue_size=10)
        
        self.pose_pub = rospy.Publisher(f"{self.robot_name}/poses", PoseStamped, queue_size=10)
        self.status_pub = rospy.Publisher(f"{self.robot_name}/status", String, queue_size=10)
    ...
    def multi_pose_callback(self, msg:PoseStamped):
        # TODO: Check is this needed
        pass
    
    def mission_callback(self, msg:String):
        l = msg.data.split()
        if l[0] == self.robot_name:
            self.set_mission(l[1], l[2])
