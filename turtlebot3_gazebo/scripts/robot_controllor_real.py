...
class TurtlebotController:
    def __init__(self, name):
        ...
        camera_topic = "/tb3_1/usb_cam/image_raw" if self.robot_name == "tb3_1" else "/tb3_2/cv_camera/image_raw"
        info_topic = "/tb3_1/usb_cam/camera_info" if self.robot_name == "tb3_1" else "/tb3_2/cv_camera/camera_info"
        ...
        self.image_sub = rospy.Subscriber(camera_topic, Image, self.image_callback, queue_size=10)
        self.info_sub = rospy.Subscriber(info_topic, CameraInfo, self.camera_info_callback, queue_size=10)
